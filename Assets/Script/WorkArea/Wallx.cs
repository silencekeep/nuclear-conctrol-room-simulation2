...
{
    public class Wallx : MonoBehaviour, IWallAdjust
    {
        float wallLength;
        float wallWidth;
        float wallHeight;
        ...
        {
            gameObject.transform.position = new Vector3(wallLength, wallHeight / 2, wallWidth / 2);
        }

        public void SetWallScale(double length, double width)
        {
            gameObject.transform.localScale = new Vector3((float)0.01, wallHeight, wallWidth);
        }
