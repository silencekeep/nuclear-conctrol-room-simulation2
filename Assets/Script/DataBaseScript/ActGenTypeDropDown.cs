...
public class ActGenTypeDropDown : MonoBehaviour
{
    public Dropdown ActType1DropDown;
    //public Dropdown ActDropDown;
    private SqlConnection sqlCon;
    
    public static bool ActType1DropDownValueChanged;
    ...
    {
        ActType1DropDownValueChanged = true;
    }
    ...
    void Update()
    {
        ...
        if (ActType1DropDown.value == 0)
        {
            ActType1DropDown.captionText.text = dropdown.options[0].text;
        }
    }
}
