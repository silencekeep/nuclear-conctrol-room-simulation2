...
public class ActManager : MonoBehaviour
{
   ...
   // public static bool EditActPathSign;
    ...
    //public GameObject Editpanel;
    string ActEditzhanzi = null;
    string ActEditzuozi = null;
    ...
    public void ConditionalQueryTable1()//站姿   显示动素条件查询结果（种类）    
    {
        //int count = table1.transform.childCount;
        //for (int i = 0; i < count; i++)
        //{
        ...
        System.Data.DataSet dc = sqlconnect.Instance.sqlquery("select * from zhanzi where percentage='" + Qtype1 + "'");
    ...
    public void ConditionalQueryTable2()//坐姿   显示动素条件查询结果（种类）    
    {
        //int count = table1.transform.childCount;
        //for (int i = 0; i < count; i++)
        //{
    ...
    public void EditYesButtonClicked1()//数据库编辑功能  站姿
    {
        ...
        //sqlCon = new SqlConnection(sqlAddress);
        //sqlCon.Open();
        //if (nameIputField_Standing.text == RowScripts.percentage_StandingText)
        //{

            ActEditzhanzi = "update zhanzi set height='" + height_StandingInputField.text + "', seegle='" + seegle_StandingInputField.text + "', shoulder='" + shoulder_StandingInputField.text + "', fingertips = '" + fingertips_StandingInputField.text + "', stretch = '" + stretch_StandingInputField.text + "', axisDistance='" + axisDistance_StandingInputField.text + "' , centralAxisToEye = '" + centralAxisToEye_StandingInputField.text + "' , eyeToSide='" + eyeToSide_StandingInputField.text + "', shoulderToSide='" + shoulderToSide_StandingInputField.text + "', percentage='" + nameIputField_Standing.text + "'  where percentage = '" + RowScripts.percentage_StandingText + "'";

        //}
        //else if(nameIputField_Standing.text != RowScripts.percentage_StandingText)
        //{
        //    ActEditzhanzi = "insert into zhanzi (height,seegle,shoulder,fingertips,stretch,axisDistance,centralAxisToEye,eyeToSide,shoulderToSide,percentage) values ('" + height_StandingInputField.text + "','" + seegle_StandingInputField.text + "','" + shoulder_StandingInputField.text + "','" + fingertips_StandingInputField.text + "','" + stretch_StandingInputField.text + "','" + axisDistance_StandingInputField.text + "','" + centralAxisToEye_StandingInputField.text + "','" + eyeToSide_StandingInputField.text + "','" + shoulderToSide_StandingInputField.text + "','" + nameIputField_Standing.text + "')";

        //}

        sqlconnect.Instance.sqladd(ActEditzhanzi);
       ...
       // EditActPathSign = false;
        ...
        //sqlCon.Open();
         ActEditzuozi = "update zuozi set belowTheKnee='" + belowTheKnee_SittingInputField.text + "', heightAboveChair='" + heightAboveChair_SittingInputField.text + "', seegleAboveChair='" + seegleAboveChair_SittingInputField.text + "', shoulderAboveChair = '" + shoulderAboveChair_SittingInputField.text + "', stretch = '" + stretch_SittingInputField.text + "', thigh='" + thigh_SittingInputField.text + "', hipToKneeMesial = '" + hipToKneeMesial_SittingInputField.text +
           ...
           "', bodyToToes = '" + bodyToToes_SittingInputField.text + "', eyeToSide = '" + eyeToSide_SittingInputField.text + "', shoulderToSide = '" + shoulderToSide_SittingInputField.text + "', percentage = '" + nameIputField_Sitting.text + "'  where percentage = '" + RowScripts.percentage_SittingText + "'";
        
        sqlconnect.Instance.sqladd(ActEditzuozi);
        //SqlCommand sqlCommand = new SqlCommand(ActEdit, sqlCon);
        //sqlCommand.ExecuteNonQuery();
        //sqlCon.Close();
        editokpanel.SetActive(true);
