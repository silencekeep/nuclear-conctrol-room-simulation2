...
using System;
using SuperTreeView;
//using TreeViewSceneScript;

public class TreeViewItemScript : MonoBehaviour//原ItemScript2
{
    ...
    void OnItemClicked()
    {
        ...
        TreeViewSceneScript treeview = new TreeViewSceneScript();
        treeview.Database.SetActive(true);
