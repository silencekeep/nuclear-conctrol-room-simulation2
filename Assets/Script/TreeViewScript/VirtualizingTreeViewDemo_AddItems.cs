...
namespace Battlehub.UIControls
{
    ...
    public class VirtualizingTreeViewDemo_AddItems : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //****自编代码****
            DataItem dataItem1 = new DataItem("准备阶段" );           
            m_dataItems.Add(dataItem1);
            
            DataItem dataItem2 = new DataItem("实施阶段");
            m_dataItems.Add(dataItem2);
            DataItem dataItem3 = new DataItem("测试阶段");
            m_dataItems.Add(dataItem3);
        ...
        public void DeleteDZ()
        {
            ...
            //VirtualizingItemsControl virtualizingItemsControl = new VirtualizingItemsControl();
            //virtualizingItemsControl.RemoveSelectedItems();
            //print("执行");
        }
