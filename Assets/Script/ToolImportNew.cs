...
public class ToolImportNew : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ToolcadLoader = toolButton.GetComponent<CADLoader>();
        //ToolcadLoader = new CADLoader();
        //cadLoader.ImportEnded += CADImportEnded;
        ToolcadLoader.sceneRoot = toolimported;
    }
