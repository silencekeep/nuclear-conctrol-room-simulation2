...
{
    public class Elbow_R : MonoBehaviour, IJoint
    {
        ...
        float y_LimitMin_Max = -135;
        float y_LimitMin_Min = -150;
        ...
        {
            return model.GetComponent<Animator>().GetBoneTransform(HumanBodyBones.RightLowerArm).gameObject.transform.localEulerAngles;
        }
        ...
        {
            model.GetComponent<Animator>().GetBoneTransform(HumanBodyBones.RightLowerArm).gameObject.transform.localEulerAngles = angle;
        ...
        public void SetCurrentAngle(GameObject model, float x, float y, float z)
        {
            ...
            model.GetComponent<Animator>().GetBoneTransform(HumanBodyBones.RightLowerArm).localEulerAngles = new Vector3(x, y, z);
