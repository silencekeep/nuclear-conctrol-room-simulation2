...
Shader "CrossSection/Standard" 
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_PLANE CLIP_TWO_PLANES CLIP_CUBE CLIP_BOX CLIP_SPHERE
			//#pragma multi_compile_local __ CLIP_PLANE CLIP_TWO_PLANES CLIP_CUBE CLIP_BOX CLIP_SPHERE // to get enumerated keywords as local.
