...
Shader "CrossSection/Standard (Specular setup)"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_PLANE CLIP_TWO_PLANES CLIP_BOX CLIP_SPHERES
			//#pragma multi_compile_local __ CLIP_PLANE CLIP_TWO_PLANES CLIP_BOX CLIP_SPHERE // to get enumerated keywords as local.#pragma shader_feature_local RETRACT_BACKFACES
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_PLANE CLIP_TWO_PLANES CLIP_BOX CLIP_SPHERES
			//#pragma multi_compile_local __ CLIP_PLANE CLIP_TWO_PLANES CLIP_BOX CLIP_SPHERES // to get enumerated keywords as local.
			#include "CGIncludes/UnityStandardCoreForward_CS.cginc"
