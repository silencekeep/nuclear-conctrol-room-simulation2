...
namespace WorldSpaceTransitions
{
    ...
    public class Planar_xyzClippingSection : MonoBehaviour, ISizedSection
    {
        ...
        public void SliderListener(float value)
        {
            ...
            if (rectGizmo)
            {
                rectGizmo.transform.localPosition = (boundsMode == BoundsOrientation.worldOriented) ? gpos : glocpos;
            }
        ...
        void setSection()
        {
            ...
            if (boundsMode == BoundsOrientation.objectOriented)
            {
                rectGizmo.transform.localPosition = sectionpointLocal;
            }
            else
            {
        ...
        void setupGizmo()
        {
            ...
            if (boundsMode == BoundsOrientation.objectOriented) rectGizmo.transform.SetParent(model.transform);
