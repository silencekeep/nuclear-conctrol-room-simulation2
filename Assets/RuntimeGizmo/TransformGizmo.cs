...
namespace RuntimeGizmos
{
	...
	public class TransformGizmo : MonoBehaviour
	{
		...
		{
			HandleUndoRedo();
			GameObject Scripts = GameObject.Find("2DUI/Canvas/KeDa");
			Scripts.GetComponent<KeDa>().refreshFlag = true;
			Scripts = GameObject.Find("2DUI/Canvas/KeShi");
			Scripts.GetComponent<KeShi>().refreshFlag = true;
			Scripts = GameObject.Find("2DUI/Canvas/GongXiao");
			Scripts.GetComponent<Analyse>().refreshFlag = true;
			SetSpaceAndType();
